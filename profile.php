        ...
        <div style="border: 2px solid #f0aa13; padding: 20px; border-radius: 10px;">
            ...
            <?php if (isset($_SESSION['userId'])): ?>
                <div style="text-align: center;">
                    <div style="border: 2px solid #f0aa13; border-radius: 50%; width: 150px; height: 150px; margin: 0 auto; overflow: hidden;">
                        <!-- Вместо ссылки на изображение подставьте путь к фото пользователя -->
                        <img src="user.avif" alt="Фото пользователя" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    ...
                    <p style="margin-top: 10px; font-size: 18px;">Личная скидка: 15%</p>
